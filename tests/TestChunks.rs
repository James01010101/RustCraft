...
fn Test_GetWorldBlockPos_1() {
    ...
    let result: (i32, i16, i32) =
        get_world_block_pos(chunkX, chunkZ, relBlockX, relBlockY, relBlockZ, &world);
...
fn Test_GetChunkBlockPos_1() {
    ...
    let result: (i32, i16, i32) =
        get_relative_block_pos(worldBlockX, worldBlockY, worldBlockZ, &world);
